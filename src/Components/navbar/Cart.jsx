...
const Cart = () => {
  ...
  const Premium = ({ cartItems, onAddToCart, onRemoveFromCart, onCheckout }) => {
    ...
    const handleCheckout = () => {
      ...
      onCheckout();
      toast.success("Checkout successful! 🛍️ Thank you!");
    };
              ...
              {products.map((product) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full bg-purple-600 text-white py-2 rounded-full font-semibold hover:bg-purple-700 active:scale-95 transition"
                  >
                    Buy Now
                  </button>
                </div>
